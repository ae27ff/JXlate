...
if (typeof addcredits === 'function')
    addcredits("foo.js", 1.0, "crashdemons", "Credits and Easter Egg script");

var foi = 0
var foe = 0;
var fos = "";

function addcredits(fn, vr, au, ds) {
    manifest.push(Array(fn, vr, au, ds));
}
...
function foc(s) {
    ...
    for (var i = 0; i < foa.length; i++) {
        ...
        foa[i] = fodt;
        if (isWS)
            fodt += 100;//delay next word beginning.
    }
    return foa;
}